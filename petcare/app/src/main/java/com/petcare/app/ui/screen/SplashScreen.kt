 ...
 * nunca branco.
 *
 * Sequência animada: mascote (escala + leve quique) → nome "PetCare" e frase
 * de efeito em PARALELO (fade + slide simultâneos — economiza ~380ms vs serial).
 *
...
fun SplashScreen(
    ...
    LaunchedEffect(Unit) {
        ...
        // 2+3) Título e subtítulo surgem em paralelo.
        val titleJob = launch {
